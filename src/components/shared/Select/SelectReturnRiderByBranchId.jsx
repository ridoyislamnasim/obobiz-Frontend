...
const SelectReturnRiderByBranchId = ({
    errors,
    control,
    setState,
    setItem,
    ...
    return (
        <>
            ...
            />
            <ReactSelectError errorName={errors?.[name ? name : 'return_rider_id']} />
        </>
    );
};

export default SelectReturnRiderByBranchId;
