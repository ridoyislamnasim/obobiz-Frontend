...
const SelectPickupRiderByBranchId = ({
    errors,
    control,
    setState,
    setItem,
    ...
    return (
        <>
            ...
            />
            <ReactSelectError errorName={errors?.[name ? name : 'pick_up_rider_id']} />
        </>
    );
};

export default SelectPickupRiderByBranchId;
