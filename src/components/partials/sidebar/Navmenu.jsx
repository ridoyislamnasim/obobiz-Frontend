...
const Navmenu = () => {
	...
	console.log("are you here auth ? ", auth);
	console.log("are you here auth ? ", auth?.user?.role);

	const menus = navMenu(auth?.user?.user_type, auth?.user?.role, auth?.user?.user_info?.branch_id);
